      ...
      <main className="relative">
        ...
        <div className="relative max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-xl mx-auto text-lg text-black dark:text-yellow-400">
          ...
          <h2 className="text-3xl font-bold text-black  text-center sm:text-4xl flex items-center justify-center space-x-2">
